...
Info CS Games: [http://2020.csgames.org](http://2020.csgames.org)
        ...
        """),
        Event(name='JDIS Games 2019', teams=True, is_visible=True, is_open=True, front_page='**JDISGames 2019**'),
        Event(name='Pico CTF 2019', teams=False, is_visible=True, is_open=True, front_page='**PicoCTF 2019**'),
        Event(name='United CTF 2019', teams=False, is_visible=True, is_open=True, front_page='**UnitedCTF 2019**')
    ]
