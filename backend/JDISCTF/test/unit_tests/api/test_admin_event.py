...
class TestCreateEvent:
    REQUEST_BODY = {"name": "Test Event", "teams": True, "is_open": False, "is_visible": False, "front_page": "", "url": "", "flag_format": ""}
    A_NEW_EVENT = Event(name=REQUEST_BODY["name"], teams=REQUEST_BODY["teams"], is_open=REQUEST_BODY["is_open"], is_visible=REQUEST_BODY["is_visible"],
                        front_page=REQUEST_BODY["front_page"], url=REQUEST_BODY["url"], flag_format=REQUEST_BODY["flag_format"])
